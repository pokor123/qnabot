...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerPreviewDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerPreviewDialog() : base(new QnAMakerService(new QnAMakerAttribute(RootDialog.GetSetting("QnAAuthKey"), Utils.GetAppSetting("QnAKnowledgebaseId"), "I do not know answer to your question how else can i help you?", 0.3, 3)))
        { }
    }
